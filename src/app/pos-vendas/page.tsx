...
export default function PosVendasPage() {
  return (
    <div className="min-h-[80vh] flex flex-col items-center justify-center p-6 text-center max-w-md mx-auto space-y-4">
      ...
      <h1 className="text-lg font-bold text-white font-display">Módulo de Pós Vendas</h1>
      <p className="text-xs text-neutral-400 font-mono leading-relaxed">
        Este setor está em fase de modelagem de dados para pesquisas de satisfação NPS e retorno programado de clientes da oficina.
      </p>
